            ...
            <section id='about-me'>
                ...
                <div className='about-me-info'>
                    <p>I have been interested in problem solving, math, and logic puzzles for as long as I can remember with coding being a more recent development.
                        If you put your mind to it, almost anything is possible within the code you write; I believe this to be the best part about coding. I also enjoy the
                    ...
                    <p>Working with like-minded individuals is a dream of mine which is coming ever closer to fruition. While building the Battleship app, shown in the
                        project section, I was nominated as 'Project Manager,' and was afforded the opportunity to work for three weeks in a small team alongside three others. This experience has both shown me
                    ...
                    <p>I was born in Utah and have lived here my entire life. My favorite place I’ve visited is the pacific northwest, specifically western Washington
                        in the Seattle area due to the rain, beautiful green forests, and cold Pacific Ocean. I would take a gray, overcast sky over a blue, sunny one any
                    ...
                    <p>Something strange about me is my habit of learning during my relaxation time. If I'm doing something that doesn’t require my full attention,
                        I often choose to listen to an educational video in the background. I am also never without a book, so if there is time, I read. </p>
                </div>
